...
$report2 = " <h4> All rights reserved - brlndtech © (FR) |  More Info ? <a href =""https://github.com/brlndtech/windows-pc-report"" target=""_blank""> check my github </a> <br> </strong> </div> </center> "
